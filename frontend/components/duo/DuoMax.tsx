...
export default function DuoMax({ open, onClose, sessionId, onSend }: {
  ...
  useEffect(() => {
    if (open && messages.length === 0) {
      setMessages([{ role: 'assistant', content: 'Hi! 👋 I\'m Duo Max, your Spanish tutor. Ask in English — I\'ll explain grammar and help improve your sentences, with Spanish examples when useful. ✨' }])
    }
  }, [open])
          ...
          <motion.div initial={{ y: 40 }} animate={{ y: 0 }} exit={{ y: 40 }} onClick={e => e.stopPropagation()}
            ...
            <div className="px-5 py-4 border-b-2 border-outline flex items-center gap-3 bg-gradient-to-r from-duo-purple to-duo-blue text-white">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs opacity-90 font-bold">AI Spanish tutor • Answers in English</div>
              </div>
            ...
            <div className="p-4 border-t-2 border-outline surface">
              <div className="flex gap-2">
                <input value={input} onChange={e => setInput(e.target.value)}
                  ...
                  placeholder="Ask in English about Spanish…" disabled={busy}
